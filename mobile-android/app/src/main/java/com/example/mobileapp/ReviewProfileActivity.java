...
public class ReviewProfileActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawerLayout = findViewById(R.id.reviewsProfile);
        ...
        profileBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReviewProfileActivity.this, ProfileActivity.class);
        ...
        //Animacion icono menu desplegable
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_profile) {
                    ...
                    Intent intent = new Intent(ReviewProfileActivity.this, MainScreenActivity.class);
                    startActivity(intent);
                }
